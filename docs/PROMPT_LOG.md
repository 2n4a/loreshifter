...
# Commit – “Добавлен тестовый сценарий проигрыша игроков”

Необходимо в дополнение к захардкоженному сценарию победы над боссом 
добавить сценарий, где проигрывают игроки – в playtest пусть будет отдельное 
булево поле для хоста игры, в котором будет указано, какой сценарий выбрать 
для теста. 

Также необходимо в сценарии победы над боссом добавить рандомную смерть 
одного из персонажей – желательно, чтобы он умирал не от одного удара, а от 
нескольких ходов босса.
